"""
Django settings for jjsystem project.
...
WSGI_APPLICATION = 'jjsystem.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://postgres:postgres@localhost:5432/jjsystem',
        conn_max_age=600
    )
    # 'default': {
